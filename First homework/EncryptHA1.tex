...
\begin{enumerate}[label={}]
	...
	\item \textbf{Task 5} Breaking ciphertext encrypted with Vigenère cipher\\
		...
		\end{itemize}
		The difference between two appearance of a group of letters (trio of letters in this case) is most likely a multiple of the key, based on how the Vigenère cipher works. In our case this is most likely 5.\\
